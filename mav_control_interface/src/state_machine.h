...
class StateMachineDefinition : public msm_front::state_machine_def<StateMachineDefinition>
{
 ...
 public:
  ...
  struct transition_table : boost::mpl::vector<
      ...
      //  +---------+-------------+---------+---------------------------+----------------------+
      msm_front::Row<RemoteControl, RcUpdate, InternalTransition, SetReferenceFromRc, RcModeNotManual >,
      msm_front::Row<RemoteControl, RcUpdate, RemoteControlReadyForOdometry, SetReferenceFromRc, RcModeManual >,
      msm_front::Row<RemoteControl, OdometryWatchdog, InternalTransition, PrintOdometryWatchdogWarning, OdometryOutdated >,
      //  +---------+-------------+---------+---------------------------+----------------------+
      msm_front::Row<RemoteControlReadyForOdometry, RcUpdate, RemoteControl, SetReferenceFromRc, RcModeNotManual >,
      msm_front::Row<RemoteControlReadyForOdometry, RcUpdate, InternalTransition, SetReferenceFromRc, RcModeManual >,
      ...
      //  +---------+-------------+---------+---------------------------+----------------------+
      msm_front::Row<HaveOdometry, RcUpdate, InternalTransition, SetReferenceFromRc, RcModeManual >,
      ...
      //  +---------+-------------+---------+---------------------------+----------------------+
      msm_front::Row<PositionHold, RcUpdate, RemoteControl, SetReferenceFromRc, RcModeManual>,
      msm_front::Row<PositionHold, RcUpdate, RcTeleOp, SetReferenceFromRc, RcActivePosition >,
