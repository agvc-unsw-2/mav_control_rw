...
void setup_pointers(void) {
  ...
  vars.x_11 = work.x + 173;
  vars.x_12 = work.x + 181;
  vars.x_13 = work.x + 189;
  vars.x_14 = work.x + 197;
  vars.x_15 = work.x + 205;
  vars.x_16 = work.x + 213;
}
...
void fillrhs_cc(void) {
  ...
  double minval;
  r2 = work.rhs + 221;
  ds_aff = work.lhs_aff + 221;
  dz_aff = work.lhs_aff + 317;
  mu = 0;
  for (i = 0; i < 96; i++)
