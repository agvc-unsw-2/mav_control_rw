...
void setup_pointers(void) {
  ...
  vars.x_11 = work.x + 193;
  vars.x_12 = work.x + 203;
  vars.x_13 = work.x + 213;
  vars.x_14 = work.x + 223;
  vars.x_15 = work.x + 233;
...
double eval_objv(void) {
  ...
  objv += work.quad_203336859648[0]+work.quad_447791480832[0]+work.quad_295866224640[0]+work.quad_600568381440[0]+work.quad_885004812288[0]+work.quad_898851794944[0]+work.quad_469996625920[0]+work.quad_88433618944[0]+work.quad_768722419712[0]+work.quad_240204779520[0]+work.quad_757472997376[0]+work.quad_635618762752[0]+work.quad_179070365696[0]+work.quad_732753989632[0]+work.quad_384536985600[0]+work.quad_427523055616[0]+work.quad_498084270080[0]+work.quad_976046530560[0]+work.quad_452736155648[0]+work.quad_688550678528[0]+work.quad_31005663232[0]+work.quad_304816418816[0]+work.quad_68114292736[0]+work.quad_819339411456[0]+work.quad_618980339712[0]+work.quad_101800079360[0]+work.quad_615069044736[0]+work.quad_976903761920[0]+work.quad_374380896256[0]+work.quad_141299838976[0]+work.quad_74079137792[0]+work.quad_343404097536[0]+work.quad_811402448896[0]+work.quad_136942120960[0];
  return objv;
}
...
void fillrhs_cc(void) {
  ...
  double minval;
  r2 = work.rhs + 253;
  ds_aff = work.lhs_aff + 253;
  dz_aff = work.lhs_aff + 349;
  mu = 0;
  for (i = 0; i < 96; i++)
