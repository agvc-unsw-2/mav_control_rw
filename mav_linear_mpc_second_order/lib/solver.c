/* Produced by CVXGEN, 2019-08-01 23:42:43 -0400.  */
...
void setup_pointers(void) {
  ...
  vars.x_8 = work.x + 165;
  vars.x_9 = work.x + 177;
  vars.x_10 = work.x + 189;
  vars.x_11 = work.x + 201;
  vars.x_12 = work.x + 213;
  vars.x_13 = work.x + 225;
  vars.x_14 = work.x + 237;
}
...
void fillrhs_cc(void) {
  ...
  double minval;
  r2 = work.rhs + 249;
  ds_aff = work.lhs_aff + 249;
  dz_aff = work.lhs_aff + 333;
  mu = 0;
  for (i = 0; i < 84; i++)
