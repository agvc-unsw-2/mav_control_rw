 ...
 * 
 *  Matrix containing 5 reference/measurement vectors of size 13 for first 5 nodes.
 */
real_t y[ 65 ];
...
/** Matrix of size: 15 x 13 (row major format) */
real_t R2[ 195 ];
...
/** Matrix of size: 12 x 3 (row major format) */
real_t W1[ 36 ];
